          ...
          include "connect.php" ;
           ...
           if ($resultat) {
               while ($row  = mysqli_fetch_assoc($resultat)) {
                   ...
                   <td>
               <button class="btn btn-primary"><a href="modifier form article.php?modifier='.$id.'" class="text-light">Modifier</a></button>
               <button class="btn btn-danger"><a href="supprimer form article.php?supprimeid='.$id.'" class="text-light">Supprimer</a></button>
           </td>
                   </tr>';
               }
           }
