  ...
  <main id="main" class="main">
    ...
    <form class="form-art" method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" name="prix_achat" id="prix_achat" required>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                 ...
                 <button type="reset" name="login" class="bt-annuler">Annuler</button>
                 </form> <br>
...
if (isset($_POST['login'])) {
    ...
    $sql = "insert into achat(designation,prix_achat,prix_vente,quantite,montant) values('$designation', '$prix_achat','$prix_vente','$quantite','$montant')";
